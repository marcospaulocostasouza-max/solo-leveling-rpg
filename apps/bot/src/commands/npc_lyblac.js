 ...
 * COMANDO: !lyblac
 * 
 * Exibe a ficha completa do NPC Lyblac.
 * 
 * Uso:
 * - !lyblac - Exibe a ficha do NPC
 * - !lyblac ficha - Exibe a ficha detalhada
 * - !lyblac conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("lyblac");
    ...
    // =====================================
    // !lyblac ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!lyblac ficha" || texto === "!lyblac ficha completa") {
        let mensagem = `*═══ FICHA DE LYBLAC ═══*
`;
        mensagem += `──────────────────────────
