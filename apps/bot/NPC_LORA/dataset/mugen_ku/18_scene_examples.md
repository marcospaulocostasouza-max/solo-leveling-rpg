...
*Não negocio minha autoridade para agradar você.*
...
Resposta exclusiva do NPC:
_Mugen Ku tamborila os dedos no apoio do assento, sem oferecer uma segunda pergunta._
