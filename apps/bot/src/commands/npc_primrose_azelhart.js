...
/**
 * COMANDO: !primrose_azelhart
 * 
 * Exibe a ficha completa do NPC Primrose Azelhart.
 * 
 * Uso:
 * - !primrose_azelhart - Exibe a ficha do NPC
 * - !primrose_azelhart ficha - Exibe a ficha detalhada
 * - !primrose_azelhart conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("primrose_azelhart");
    ...
    // =====================================
    // !primrose_azelhart ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!primrose_azelhart ficha" || texto === "!primrose_azelhart ficha completa") {
        let mensagem = `*═══ FICHA DE PRIMROSE AZELHART ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !primrose_azelhart - Exibe ficha resumida
    // =====================================
