 ...
 * COMANDO: !hikari_ku
 * 
 * Exibe a ficha completa do NPC Hikari Ku.
 * 
 * Uso:
 * - !hikari_ku - Exibe a ficha do NPC
 * - !hikari_ku ficha - Exibe a ficha detalhada
 * - !hikari_ku conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("hikari_ku");
    ...
    // =====================================
    // !hikari_ku ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!hikari_ku ficha" || texto === "!hikari_ku ficha completa") {
        let mensagem = `*═══ FICHA DE HIKARI KU ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !hikari_ku - Exibe ficha resumida
    // =====================================
