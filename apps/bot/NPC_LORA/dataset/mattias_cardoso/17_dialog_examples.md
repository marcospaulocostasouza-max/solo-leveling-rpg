# Exemplos de diálogo — Mattias Cardoso
...
*Entre, meu filho. O que o preocupa?*
...
Resposta exclusiva do NPC:
*É mais fácil conversar quando não precisamos disputar quem fala primeiro.*
...
Resposta exclusiva do NPC:
*Você procura orientação ou absolvição?*
