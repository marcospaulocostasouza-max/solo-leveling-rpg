...
Resposta exclusiva do NPC:
*Esta sala está mais agradável quando ninguém tenta preenchê-la com conversa.*
...
Resposta exclusiva do NPC:
*Isso é uma justificativa ou um pedido?*
