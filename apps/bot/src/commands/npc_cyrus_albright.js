...
/**
 * COMANDO: !cyrus_albright
 * 
 * Exibe a ficha completa do NPC Cyrus Albright.
 * 
 * Uso:
 * - !cyrus_albright - Exibe a ficha do NPC
 * - !cyrus_albright ficha - Exibe a ficha detalhada
 * - !cyrus_albright conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // =====================================
    // !cyrus_albright ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!cyrus_albright ficha" || texto === "!cyrus_albright ficha completa") {
        let mensagem = `*═══ FICHA DE CYRUS ALBRIGHT ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !cyrus_albright - Exibe ficha resumida
    // =====================================
