...
/**
 * COMANDO: !temenos_mistral
 * 
 * Exibe a ficha completa do NPC Temenos Mistral.
 * 
 * Uso:
 * - !temenos_mistral - Exibe a ficha do NPC
 * - !temenos_mistral ficha - Exibe a ficha detalhada
 * - !temenos_mistral conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("temenos_mistral");
    ...
    // =====================================
    // !temenos_mistral ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!temenos_mistral ficha" || texto === "!temenos_mistral ficha completa") {
        let mensagem = `*═══ FICHA DE TEMENOS MISTRAL ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !temenos_mistral - Exibe ficha resumida
    // =====================================
