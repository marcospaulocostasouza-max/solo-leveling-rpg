# Exemplos de cena — Castti Florenz
...
*Não posso prometer que será fácil. Posso ficar e ajudar.*
...
Resposta exclusiva do NPC:
_Castti Florenz deixa as mãos em repouso, sem iniciar um exame que não foi autorizado._
