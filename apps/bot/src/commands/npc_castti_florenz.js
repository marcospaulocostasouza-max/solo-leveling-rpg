...
/**
 * COMANDO: !castti_florenz
 * 
 * Exibe a ficha completa do NPC Castti Florenz.
 * 
 * Uso:
 * - !castti_florenz - Exibe a ficha do NPC
 * - !castti_florenz ficha - Exibe a ficha detalhada
 * - !castti_florenz conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("castti_florenz");
    ...
    // =====================================
    // !castti_florenz ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!castti_florenz ficha" || texto === "!castti_florenz ficha completa") {
        let mensagem = `*═══ FICHA DE CASTTI FLORENZ ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !castti_florenz - Exibe ficha resumida
    // =====================================
