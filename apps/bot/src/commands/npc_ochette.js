 ...
 * COMANDO: !ochette
 * 
 * Exibe a ficha completa do NPC Ochette.
 * 
 * Uso:
 * - !ochette - Exibe a ficha do NPC
 * - !ochette ficha - Exibe a ficha detalhada
 * - !ochette conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("ochette");
    ...
    // =====================================
    // !ochette ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!ochette ficha" || texto === "!ochette ficha completa") {
        let mensagem = `*═══ FICHA DE OCHETTE ═══*
`;
        mensagem += `──────────────────────────
