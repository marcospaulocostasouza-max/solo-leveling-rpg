# Exemplos de cena — Cyrus Albright
...
*Ainda não temos provas. Seria precipitado chamar isso de descoberta.*
...
Resposta exclusiva do NPC:
_Cyrus Albright suspende a anotação no meio de uma linha para não perder a próxima resposta._
