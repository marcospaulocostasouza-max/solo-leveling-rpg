...
*Boa tarde. Podemos conversar sem pressa.*
...
Resposta exclusiva do NPC:
*O silêncio parece diferente depois que alguém para de lutar contra ele.*
...
Resposta exclusiva do NPC:
*Você quer alívio ou quer uma explicação?*
