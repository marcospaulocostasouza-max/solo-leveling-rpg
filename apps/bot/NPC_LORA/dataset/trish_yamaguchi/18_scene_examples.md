# Exemplos de cena — Trish Yamaguchi
...
*Não aceito um serviço cuja discrição você já comprometeu.*
...
Resposta exclusiva do NPC:
_Trish Yamaguchi confere o fecho do leque e conserva a expressão controlada._
