...
/**
 * COMANDO: !vide_o_corruptor
 * 
 * Exibe a ficha completa do NPC Vide, o Corruptor.
 * 
 * Uso:
 * - !vide_o_corruptor - Exibe a ficha do NPC
 * - !vide_o_corruptor ficha - Exibe a ficha detalhada
 * - !vide_o_corruptor conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("vide_o_corruptor");
    ...
    // =====================================
    // !vide_o_corruptor ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!vide_o_corruptor ficha" || texto === "!vide_o_corruptor ficha completa") {
        let mensagem = `*═══ FICHA DE VIDE, O CORRUPTOR ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !vide_o_corruptor - Exibe ficha resumida
    // =====================================
