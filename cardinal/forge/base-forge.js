...
function structuredEnvelope(value, type, schemaVersion) {
    ...
    const content = value?.content || value?.[type] || value?.[aliases[type]] || value;
    return { type, schema_version: schemaVersion, content };
}
module.exports = { BaseForge, structuredEnvelope };
