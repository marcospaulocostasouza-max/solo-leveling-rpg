...
/**
 * COMANDO: !osvald_v_vanstein
 * 
 * Exibe a ficha completa do NPC Osvald V. Vanstein.
 * 
 * Uso:
 * - !osvald_v_vanstein - Exibe a ficha do NPC
 * - !osvald_v_vanstein ficha - Exibe a ficha detalhada
 * - !osvald_v_vanstein conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("osvald_v_vanstein");
    ...
    // =====================================
    // !osvald_v_vanstein ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!osvald_v_vanstein ficha" || texto === "!osvald_v_vanstein ficha completa") {
        let mensagem = `*═══ FICHA DE OSVALD V. VANSTEIN ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !osvald_v_vanstein - Exibe ficha resumida
    // =====================================
