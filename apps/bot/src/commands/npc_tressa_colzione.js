...
/**
 * COMANDO: !tressa_colzione
 * 
 * Exibe a ficha completa do NPC Tressa Colzione.
 * 
 * Uso:
 * - !tressa_colzione - Exibe a ficha do NPC
 * - !tressa_colzione ficha - Exibe a ficha detalhada
 * - !tressa_colzione conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("tressa_colzione");
    ...
    // =====================================
    // !tressa_colzione ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!tressa_colzione ficha" || texto === "!tressa_colzione ficha completa") {
        let mensagem = `*═══ FICHA DE TRESSA COLZIONE ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !tressa_colzione - Exibe ficha resumida
    // =====================================
