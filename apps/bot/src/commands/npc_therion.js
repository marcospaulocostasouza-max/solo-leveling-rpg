 ...
 * COMANDO: !therion
 * 
 * Exibe a ficha completa do NPC Therion.
 * 
 * Uso:
 * - !therion - Exibe a ficha do NPC
 * - !therion ficha - Exibe a ficha detalhada
 * - !therion conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("therion");
    ...
    // =====================================
    // !therion ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!therion ficha" || texto === "!therion ficha completa") {
        let mensagem = `*═══ FICHA DE THERION ═══*
`;
        mensagem += `──────────────────────────
