 ...
 * COMANDO: !galdera
 * 
 * Exibe a ficha completa do NPC Galdera.
 * 
 * Uso:
 * - !galdera - Exibe a ficha do NPC
 * - !galdera ficha - Exibe a ficha detalhada
 * - !galdera conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("galdera");
    ...
    // =====================================
    // !galdera ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!galdera ficha" || texto === "!galdera ficha completa") {
        let mensagem = `*═══ FICHA DE GALDERA ═══*
`;
        mensagem += `──────────────────────────
