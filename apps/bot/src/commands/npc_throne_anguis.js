...
/**
 * COMANDO: !throne_anguis
 * 
 * Exibe a ficha completa do NPC Throné Anguis.
 * 
 * Uso:
 * - !throne_anguis - Exibe a ficha do NPC
 * - !throne_anguis ficha - Exibe a ficha detalhada
 * - !throne_anguis conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("throne_anguis");
    ...
    // =====================================
    // !throne_anguis ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!throne_anguis ficha" || texto === "!throne_anguis ficha completa") {
        let mensagem = `*═══ FICHA DE THRONÉ ANGUIS ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !throne_anguis - Exibe ficha resumida
    // =====================================
