...
module.exports = async (msg) => {
    ...
    if (comando === "!passivas") {
        return MessageService.send({ message: msg, text: "*════════════════════════════════════*\n*PASSIVAS*\n*════════════════════════════════════*\n\nPassivas são capacidades permanentes conquistadas na jornada de um Caçador. Elas não são compradas em uma lista comum: representam marcas de eventos, dungeons, feitos narrativos e escolhas que deixaram efeito duradouro.\n\n*Todas as passivas conquistadas ficam sempre ativas.*\nNão existe comando para ativá-las ou equipá-las manualmente. Cada passiva registrada informa sua descrição e seus buffs, que são aplicados conforme as regras do efeito.\n\n› Para consultar sua lista completa: *!minhas passivas*" });
    }
