...
const SCHEMAS = Object.freeze({
    ...
    technique: { version: 1, required: ["nome", "classe", "categoria", "tipo", "descricao", "descricao_completa", "custo_mana", "cooldown", "nivel_desbloqueio", "rank"], properties: { nome: { type: "string" }, classe: { type: "string" }, categoria: { type: "string" }, tipo: { type: "string" }, descricao: { type: "string" }, descricao_completa: { type: "string" }, custo_mana: { type: "integer", minimum: 0 }, custo_qi: { type: "integer", minimum: 0 }, custo_maestria: { type: "integer", minimum: 0 }, cooldown: { type: "integer", minimum: 0 }, nivel_desbloqueio: { type: "integer", minimum: 1 }, rank: { type: "string" }, passiva: { type: "integer", minimum: 0 } } },
