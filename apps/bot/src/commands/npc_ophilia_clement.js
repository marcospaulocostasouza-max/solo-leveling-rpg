...
/**
 * COMANDO: !ophilia_clement
 * 
 * Exibe a ficha completa do NPC Ophilia Clement.
 * 
 * Uso:
 * - !ophilia_clement - Exibe a ficha do NPC
 * - !ophilia_clement ficha - Exibe a ficha detalhada
 * - !ophilia_clement conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("ophilia_clement");
    ...
    // =====================================
    // !ophilia_clement ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!ophilia_clement ficha" || texto === "!ophilia_clement ficha completa") {
        let mensagem = `*═══ FICHA DE OPHILIA CLEMENT ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !ophilia_clement - Exibe ficha resumida
    // =====================================
