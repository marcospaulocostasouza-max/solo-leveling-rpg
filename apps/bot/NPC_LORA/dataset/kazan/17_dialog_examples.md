...
*Entre. Ainda temos tempo para pensar.*
...
Resposta exclusiva do NPC:
*As pessoas falam em destino quando não gostam das opções que têm.*
...
Resposta exclusiva do NPC:
*Qual resultado estaria disposto a aceitar?*
