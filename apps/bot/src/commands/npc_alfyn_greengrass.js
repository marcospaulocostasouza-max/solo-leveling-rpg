...
/**
 * COMANDO: !alfyn_greengrass
 * 
 * Exibe a ficha completa do NPC Alfyn Greengrass.
 * 
 * Uso:
 * - !alfyn_greengrass - Exibe a ficha do NPC
 * - !alfyn_greengrass ficha - Exibe a ficha detalhada
 * - !alfyn_greengrass conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("alfyn_greengrass");
    ...
    // =====================================
    // !alfyn_greengrass ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!alfyn_greengrass ficha" || texto === "!alfyn_greengrass ficha completa") {
        let mensagem = `*═══ FICHA DE ALFYN GREENGRASS ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !alfyn_greengrass - Exibe ficha resumida
    // =====================================
