...
/**
 * COMANDO: !olberic_eisenberg
 * 
 * Exibe a ficha completa do NPC Olberic Eisenberg.
 * 
 * Uso:
 * - !olberic_eisenberg - Exibe a ficha do NPC
 * - !olberic_eisenberg ficha - Exibe a ficha detalhada
 * - !olberic_eisenberg conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("olberic_eisenberg");
    ...
    // =====================================
    // !olberic_eisenberg ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!olberic_eisenberg ficha" || texto === "!olberic_eisenberg ficha completa") {
        let mensagem = `*═══ FICHA DE OLBERIC EISENBERG ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !olberic_eisenberg - Exibe ficha resumida
    // =====================================
