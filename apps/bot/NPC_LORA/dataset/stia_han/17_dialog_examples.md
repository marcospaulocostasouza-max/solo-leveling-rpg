...
*Oi! Segura esta ponta um instante? Pronto, agora posso ouvir.*
...
Resposta exclusiva do NPC:
*Se eu guardar a ferramenta no mesmo lugar duas vezes, será um milagre.*
...
Resposta exclusiva do NPC:
*Você quer ajudar no trabalho ou precisa de abrigo?*
