 ...
 * COMANDO: !haanit
 * 
 * Exibe a ficha completa do NPC H'aanit.
 * 
 * Uso:
 * - !haanit - Exibe a ficha do NPC
 * - !haanit ficha - Exibe a ficha detalhada
 * - !haanit conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("haanit");
    ...
    // =====================================
    // !haanit ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!haanit ficha" || texto === "!haanit ficha completa") {
        let mensagem = `*═══ FICHA DE H'AANIT ═══*
`;
        mensagem += `──────────────────────────
