 ...
 * COMANDO: !trousseau
 * 
 * Exibe a ficha completa do NPC Trousseau.
 * 
 * Uso:
 * - !trousseau - Exibe a ficha do NPC
 * - !trousseau ficha - Exibe a ficha detalhada
 * - !trousseau conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("trousseau");
    ...
    // =====================================
    // !trousseau ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!trousseau ficha" || texto === "!trousseau ficha completa") {
        let mensagem = `*═══ FICHA DE TROUSSEAU ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !trousseau - Exibe ficha resumida
    // =====================================
