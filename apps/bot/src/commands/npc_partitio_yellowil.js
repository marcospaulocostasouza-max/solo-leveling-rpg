...
/**
 * COMANDO: !partitio_yellowil
 * 
 * Exibe a ficha completa do NPC Partitio Yellowil.
 * 
 * Uso:
 * - !partitio_yellowil - Exibe a ficha do NPC
 * - !partitio_yellowil ficha - Exibe a ficha detalhada
 * - !partitio_yellowil conversar - Inicia conversa com o NPC
 */
...
module.exports = async (msg) => {
    ...
    // Buscar NPC
    const npc = NPCManager.carregarNPC("partitio_yellowil");
    ...
    // =====================================
    // !partitio_yellowil ficha - Exibe ficha detalhada
    // =====================================
    if (texto === "!partitio_yellowil ficha" || texto === "!partitio_yellowil ficha completa") {
        let mensagem = `*═══ FICHA DE PARTITIO YELLOWIL ═══*
`;
        mensagem += `──────────────────────────
...
`;
    ...
    // =====================================
    // !partitio_yellowil - Exibe ficha resumida
    // =====================================
